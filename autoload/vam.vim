...
command! -nargs=* -bar -complete=customlist,vam#install#NotInstalledAddonCompletion
  \ InstallAddons :call vam#install#Install([<f-args>])
command! -nargs=* -bar -complete=customlist,vam#install#AddonCompletion
  \ ActivateAddons :call vam#ActivateAddons([<f-args>])
command! -nargs=* -bar -complete=customlist,vam#install#AddonCompletion
  \ AddonsInfo :call vam#DisplayAddonsInfo([<f-args>])
command! -nargs=* -bar -complete=customlist,vam#install#InstalledAddonCompletion
  \ ActivateInstalledAddons :call vam#ActivateAddons([<f-args>])
command! -nargs=* -bar -complete=customlist,vam#install#UpdateCompletion
  \ UpdateAddons :call vam#install#Update([<f-args>])
command! -nargs=0 -bar
  \ UpdateActivatedAddons exec 'UpdateAddons '.join(keys(g:vim_addon_manager.activated_plugins),' ')
command! -nargs=* -bar -complete=customlist,vam#install#UninstallCompletion
  \ UninstallNotLoadedAddons :call vam#install#UninstallAddons([<f-args>])

command! -nargs=* -complete=customlist,vam#bisect#BisectCompletion
  \ AddonsBisect :call vam#bisect#Bisect(<f-args>)

command! -nargs=* -bar -complete=customlist,vam#install#UninstallCompletion
  \ GitRecordAddons :call vam#install#RecordAddons([<f-args>])
